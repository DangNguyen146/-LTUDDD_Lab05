...
public class lab5_02 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lab502);
        findViewsByIds();
        initVariables();
        ...
        ivUitLogo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(lab5_02.this,lab5_03.class);
    ...
    {
        final  Animation animation = AnimationUtils.loadAnimation(lab5_02.this,animId);
